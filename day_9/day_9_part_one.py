def main():
    ...
    # for marble in range(3, int(highest_marble_value) + 1):
    #     print('Current pos', curr_marble_pos)
    #     next_pos = (curr_marble_pos + 2) % (len(marbles_played) + 1)
    #     print('Next pos', next_pos)
    #     # marble_to_left = (curr_marble_pos + 1) % (len(marbles_played) - 1)
    #     # marble_to_right = (curr_marble_pos + 2) % (len(marbles_played) - 1)
    #     # print(marble_to_left, marble_to_right)
    #     marbles_played.insert(next_pos, marble)
    #     curr_marble_pos = next_pos
    #     print('Marbles played', marbles_played)
